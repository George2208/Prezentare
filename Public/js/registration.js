...
async function listeners(){
    ...
    async function check(){
        console.log("check")
        if(cpassword.value) {
            if(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[?!._-])[a-zA-Z0-9?!._-]+$/.test(cpassword.value)){
    ...
    firstName.addEventListener("input", function(){
        if(firstName.value) {
            if(/^[a-zA-Z0-9]+([a-zA-Z0-9_.-][a-zA-Z0-9]+)*$/.test(firstName.value))
    ...
    lastName.addEventListener("input", function(){
        if(lastName.value) {
            if(/^[a-zA-Z0-9]+([a-zA-Z0-9_.-][a-zA-Z0-9]+)*$/.test(lastName.value))
    ...
    email.addEventListener("input", function(){
        if(email.value) {
            if(/^[a-zA-z0-9_-]+(\.[a-zA-z0-9_-]+)*@([a-zA-Z0-9]+\.)+[a-zA-Z]+$/.test(email.value))
    ...
    password.addEventListener("input", function(){
        check()
        if(password.value) {
            if(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[?!._-])[a-zA-Z0-9?!._-]+$/.test(password.value))
